...
function HexagonBackground({
  ...
  return (
    <div
      ...
      className={cn(
        "relative size-full overflow-hidden bg-background pointer-events-none",
        className
      )}
      {...props}
    >
        ...
        {Array.from({ length: gridDimensions.rows }).map((_, rowIndex) => (
          ...
          >
            {Array.from({ length: gridDimensions.columns }).map(
              (_, colIndex) => {
                // Calculate animation delay based on row to create top-to-bottom sweep
                const animationDelay = rowIndex * 0.15;
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      "before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-full dark:before:bg-neutral-950 before:bg-white before:transition-all before:duration-1000",
                      "after:content-[''] after:absolute after:inset-[var(--hexagon-margin)] dark:after:bg-neutral-950 after:bg-white",
                      "after:[clip-path:polygon(50%_0%,_100%_25%,_100%_75%,_50%_100%,_0%_75%,_0%_25%)]",
                      // Light sweep animation - replace hover with automatic animation
                      "before:animate-[hexagon-sweep_8s_ease-in-out_infinite]",
