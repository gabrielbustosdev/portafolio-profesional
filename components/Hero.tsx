      ...
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-12 items-center relative z-10">
        <div className="space-y-8 animate-fade-in-up">
          <div className="space-y-4">
            <div className="inline-block px-3 py-1 rounded-full bg-secondary/50 border border-primary/20 backdrop-blur-sm">
              <p className="text-primary font-mono text-xs md:text-sm tracking-widest uppercase">
